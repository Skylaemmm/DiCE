...
class DicePyTorch(ExplainerBase):
    ...
    def __init__(self, data_interface, model_interface):
        ...
        feature_num = len(self.data_interface.encoded_feature_names)
        temp_input = torch.rand([feature_num]).float().reshape(1,feature_num)
...
class GPDicePyTorch(ExplainerBase):
